    ...
    <>
      <div className="home">
        ...
        <div className="home__character-container">
          <p className="home__character-subheader">
            ...
            insightful reviews that will help you make informed decisions about
            which games to play. Unleash your imagination as you embark on epic
            adventures, solve challenging puzzles, engage in intense multiplayer
            battles, or delve into immersive storytelling experiences.
          </p>

          <div className="home__character-right"></div>
        </div>

        <div className="home__character-container">
          <div className="home__character-left"></div>
          ...
          <p className="home__character-subheader">
            ...
            library supports a wide range of platforms. Stay up to date with the
            latest gaming news, industry trends, and upcoming releases through
            our informative articles and blog posts. Engage with a vibrant
            community of fellow gamers, share your thoughts, and participate in
            discussions. Connect with friends, form gaming groups, and challenge
            each other to exciting competitions.
          </p>
        </div>
      </div>
    </>
